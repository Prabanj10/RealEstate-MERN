    ...
    <main>
      ...
      {listing && !error && !loading && (
        <div>
          ...
          <div className="fixed top-[13%] right-[3%] z-10 border rounded-full justify-center items-center bg-slate-100 cursor-pointer">
            <FaShare
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            <ul className=" flex items-center gap-4 sm:gap-6  text-green-900 text-sm flex-wrap">
